...
const TermsAndConditions = () => {
  return (
    <div className="terms-container">
      ...
      <h2 className="terms-subtitle">END USER LICENSE AGREEMENT</h2>

      <p className="terms-date">Last updated 2024,</p>

      <p className="terms-paragraph">
        Rebol Cabs, LLC is licensed to You (End-User) by Rebol Cabs, LLC,
        located at 6255 Towncenter Drive Ste 819, Clemmons, North Carolina
        27012, United States (hereinafter: Licensor), for use only under the
        terms of this License Agreement.
      </p>

      <p className="terms-paragraph">
        By downloading the Application from the Apple AppStore and Google Play,
        and any update thereto (as permitted by this License Agreement), You
      ...
      <p className="terms-paragraph">
        The parties of this License Agreement acknowledge that Apple and/or
        Google Play is not a Party to this License Agreement and is not bound by
        any provisions or obligations with regard to the Application, such as
        warranty, liability, maintenance and support thereof. Rebol Cabs, LLC,
        not Apple or Google Play, is solely responsible for the licensed
      ...
      <p className="terms-paragraph">
        ...
        Service. Rebol Cabs, LLC acknowledges that it had the opportunity to
      ...
      <h3 className="terms-heading">1. THE APPLICATION</h3>

      <p className="terms-paragraph">
        Rebol Cabs (hereinafter: Application) is a piece of software is a
        Rideshare platform - and customized for Apple and Android mobile
        devices. It is used to Connecting riders to drivers to get to point A to
        B by a push of a button.
      </p>
      ...
      <h3 className="terms-heading">2. SCOPE OF LICENSE</h3>
      ...
      <p className="terms-paragraph">
        ...
        or Google Products that You (End-User) own or control and as permitted
        by the Usage Rules set forth in this section and the App Store Terms of
      ...
      <p className="terms-paragraph">
        ...
        with Rebol Cabs, LLC's prior written consent), sell, rent, lend, lease
        or otherwise redistribute the Application.
      </p>
      ...
      <p className="terms-paragraph">
        ...
        Application, or any part thereof (except with Rebol Cabs, LLC's prior
        written consent).
      </p>
      ...
      <h3 className="terms-heading">3. TECHNICAL REQUIREMENTS</h3>
      ...
      <h3 className="terms-heading">4. MAINTENANCE AND SUPPORT</h3>
      ...
      <p className="terms-paragraph">
        ...
        Licensor at the email address listed in the App Store or Google Play
        Overview for this licensed Application.
      </p>

      <p className="terms-paragraph">
        4.2 Rebol Cabs, LLC and the End-User acknowledge that Apple and or
        Google Play has no obligation whatsoever to furnish any maintenance and
        support services with respect to the licensed Application.
      </p>

      <h3 className="terms-heading">5. USE OF DATA</h3>
      ...
      <p className="terms-paragraph">
        ...
        [http://www.RebolCabs.us/privacy](http://www.RebolCabs.us/privacy).
      </p>

      <h3 className="terms-heading">6. USER GENERATED CONTRIBUTIONS</h3>
      ...
      <h3 className="terms-heading">7. CONTRIBUTION LICENSE</h3>
      ...
      <h3 className="terms-heading">8. LIABILITY</h3>
      ...
      <h3 className="terms-heading">9. WARRANTY</h3>
      ...
      <p className="terms-paragraph">
        ...
        outside of Rebol Cabs, LLC's sphere of influence that affect the
        executability of the Application.
      </p>

      <p className="terms-paragraph">
        9.3 You are required to inspect the Application immediately after
        installing it and notify Rebol Cabs, LLC about issues discovered without
      ...
      <p className="terms-paragraph">
        9.4 If we confirm that the Application is defective, Rebol Cabs, LLC
      ...
      <h3 className="terms-heading">10. PRODUCT CLAIMS</h3>

      <p className="terms-paragraph">
        Rebol Cabs, LLC and the End-User acknowledge that Rebol Cabs, LLC, and
        not Apple, is responsible for addressing any claims of the End-User or
      ...
      <ul className="terms-list">
        <li className="terms-list-item">(i) product liability claims;</li>
        <li className="terms-list-item">
      ...
      <h3 className="terms-heading">11. LEGAL COMPLIANCE</h3>
      ...
      <h3 className="terms-heading">12. CONTACT INFORMATION</h3>
      ...
      <address className="terms-footer-address">
        ...
        United States
        <br />
        support@RebolCabs.us
      </address>

      <h3 className="terms-heading">13. TERMINATION</h3>

      <p className="terms-paragraph">
        The license is valid until terminated by Rebol Cabs, LLC or by You. Your
        rights under this license will terminate automatically and without
        notice from Rebol Cabs, LLC if You fail to adhere to any term(s) of this
      ...
      <p className="terms-paragraph">
        Rebol Cabs, LLC represents and warrants that Rebol Cabs, LLC will comply
      ...
      <h3 className="terms-heading">15. INTELLECTUAL PROPERTY RIGHTS</h3>

      <p className="terms-paragraph">
        Rebol Cabs, LLC and the End-User acknowledge that, in the event of any
        ...
        party's intellectual property rights, Rebol Cabs, LLC, and not Apple,
      ...
      <h3 className="terms-heading">16. APPLICABLE LAW</h3>

      <p className="terms-paragraph">
        This license agreement is governed by the laws of the State of North
        Carolina excluding its conflicts of law rules.
      </p>

      <h3 className="terms-heading">17. MISCELLANEOUS</h3>
